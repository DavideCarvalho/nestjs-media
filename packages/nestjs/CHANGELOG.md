...
- 5930b49: Inline Nest's `GUARDS_METADATA` key instead of deep-importing `@nestjs/common/constants`.
...
- 0c4d07e: `guards` now also accepts a per-surface object — `guards: { tus: [AdminGuard], multipart: [AuthenticatedGuard] }`
