...
The `TypeOrmMediaStore` creates the `media` table on first use by default (non-destructive — see [ORM stores](/docs/packages/orm-stores)). Nothing else to migrate to get started.
